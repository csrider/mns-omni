...
/* HealthReceiverStorageStates
 * Handles receiving device-storage related notifications from the system, and any resultant actions.
 *
 * What it does / How it works:
 * Listens for system-broadcasted events, as follows...
 *  - Device storage state (system fires ACTION_DEVICE_STORAGE_LOW / ACTION_DEVICE_STORAGE_OK)
 *      Updates global variables.
 *
 * Revisions:
 *  2020.05.20      Chris Rider     Creation (used HealthReceiverEnergyStates as a template).
 *                                  Immediately going to deprecate this, as it's deprecated in Oreo and later.
 *                                  Keeping it around for future potential use... for now, just rely on thread to check free space.
 *
 */
...
public class HealthReceiverStorageStates extends BroadcastReceiver {
    private final String TAG = this.getClass().getSimpleName();

    // Constants...
    public static final String RECEIVER_NAME = "com.messagenetsystems.evolution.receivers.healthReceiverStorageStates";
    ...
    /** Constructor */
    public HealthReceiverStorageStates(Context context, int logMethod) {
        logV("Instantiating...");
